function ML_iGC_SPAR2ch(ML, MDindex, layerMax, chNametag1, chNametag2,  ...
    iChan1, iChan2,  twlagMax, twlagMaxReg, outDirName, varargin)
% ML_iGC_SPAR2ch() RUN MD_iGC_SPAR2ch() for each MD.
%
% Updated:
