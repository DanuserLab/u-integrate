function wrapper2_MSA_multi_Seg_imDir(inputDirName)
%% example_script.m
...
% wrapper2_MSA_multi_Seg_imDir('Cytosol-Halo')
...
outputDir = fullfile(pwd, cellNames{i}, ['MSAmSeg_', chnames{1}])

%MSA_Seg_imDir(inputImgDir, outputDir, 'type', 'middle', 'parpoolNum', 1)
%MSA_Seg_multiObject_imDir(inputImgDir, outputDir, 'tightness', 0.3, ...
%    'ObjectNumber', 1, 'finalRefinementRadius', 5, 'figVisible', 'on')
%MSA_Seg_multiObject_imDir(inputImgDir, outputDir, 'tightness', 0.15, ...
%    'ObjectNumber', 1, 'finalRefinementRadius', 5, 'figVisible', 'on')
MSA_Seg_multiObject_imDir(inputImgDir, outputDir, 'tightness', 0.5, ...
    'ObjectNumber', 1, 'finalRefinementRadius', 5, 'figVisible', 'on')
%MSA_Seg_multiObject_imDir(inputImgDir, outputDir, 'numVotes', 12, ...
%    'ObjectNumber', 1, 'finalRefinementRadius', 7, 'figVisible', 'on')
