function ML_iGC_SPAR4ch_Approach2(ML, MDindex, layerMax, chNametag1, chNametag2, chNametag3, chNametag4, ...
    iChan1, iChan2, iChan3, iChan4, twlagMax, twlagMaxReg, outDirName, varargin)
% ML_iGC_SPAR4ch_update1_included_SNR RUN MD_iGC_SPAR4ch_updated1_includes_SNR() for each MD.
...
MD_iGC_SPAR4ch_Approach2(MD, iChan1, iChan2, iChan3, iChan4, chan1Name, chan2Name, chan3Name, chan4Name, layerMax,  ...
