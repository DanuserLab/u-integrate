...
%% (Four component analysis pipeline in Approach 3)
%
...
%       Run "Pipeline_GCA_4Components_Approach3.m" to implement Cross correlation analysis, 
...
%   (6) GCA of 4-components (Approach 3)
...
%% Step 6. GCA of 4-components (Approach 3)

MDGCOut = ['GCA_4Components_Approach3_', outputName];
twlagMax0 = [GCparam.tLagfr, 1];

for i=1:numel(ML.movieDataFile_) 
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh2name, LFNCh1name,'Vel',LFNCh3name, 22, 21,0,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh1name, LFNCh2name,'Vel',LFNCh3name, 21, 22,0,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh3name, LFNCh1name,'Vel',LFNCh2name, 23, 21,0,22, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh1name, LFNCh3name,'Vel',LFNCh2name, 21, 23,0,22,...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh2name, LFNCh3name,'Vel',LFNCh1name, 22, 23,0,21, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh3name, LFNCh2name,'Vel',LFNCh1name, 23, 22,0,21, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, 'Vel', LFNCh1name,LFNCh2name,LFNCh3name, 0, 21,22,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh1name, 'Vel',LFNCh2name,LFNCh3name, 21, 0,22,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, 'Vel', LFNCh2name,LFNCh1name,LFNCh3name, 0, 22,21,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh2name, 'Vel',LFNCh1name,LFNCh3name, 22, 0,21,23, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, 'Vel', LFNCh3name,LFNCh1name,LFNCh2name, 0, 23,21,22, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
    ML_iGC_SPAR4ch_Approach3(ML, i, maxLayer, LFNCh3name, 'Vel',LFNCh1name,LFNCh2name, 23, 0,21,22, ...
        twlagMax0, twlagMax0, MDGCOut, 'LB', true, 'LBoutDirName', LBout)
end 
...
disp("== Pipeline_GCA_4Componets_Approach3() is completed.")
