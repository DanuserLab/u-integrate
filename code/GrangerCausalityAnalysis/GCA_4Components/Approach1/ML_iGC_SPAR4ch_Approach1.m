function ML_iGC_SPAR4ch_Approach1(ML, MDindex, layerMax, chNametag1, chNametag2, chNametag3, chNametag4, ...
    iChan1, iChan2, iChan3, iChan4, twlagMax, twlagMaxReg, outDirName, varargin)
% ML_iGC_SPAR4ch() RUN MD_iGC_SPAR4ch() for each MD.
...
MD_iGC_SPAR4ch_Approach1(MD, iChan1, iChan2, iChan3, iChan4, chan1Name, chan2Name, chan3Name, chan4Name, layerMax,  ...
