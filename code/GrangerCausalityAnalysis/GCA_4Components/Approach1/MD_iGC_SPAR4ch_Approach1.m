function MD_iGC_SPAR4ch_Approach1(MD, iChan1, iChan2, iChan3, iChan4, chan1Name, chan2Name, chan3Name, chan4Name, layerMax, ...
...
ip.addParameter('baseOfRatioVec', [NaN, NaN, NaN, NaN]);  % base chan for ratio comp. default is ch1.
...
Qw0s = cell(layerMax, 1); %Pw2s = cell(layerMax, 1);
resiMap = cell(layerMax, 1); %Pw3s = cell(layerMax, 1);
...
%%
        [arMdlAvBICmap, arMdlAvBICcurve, reducedMdlAvBICmap, reducedMdlAvBICcurve, ...
            ...
            SPAR_4ch_mdlSlctn_iGC_3steps_Approach1(zmapx, zmapy, zmapz, zmapv, tlagMax, wlagMax, ...
