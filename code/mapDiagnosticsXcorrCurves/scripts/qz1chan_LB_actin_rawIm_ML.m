...
path1 = '/work/bioinformatics/s184919/Data/Jungsik/To_Develop_DX_FPAME_GUI_forJenny/mDia1-actin-11212013-3-Leedata';
...
path2 = '/work/bioinformatics/s184919/Data/Jungsik/To_Develop_DX_FPAME_GUI_forJenny/mDia1-actin-12052013-3-LeedataforJenny';
...
%% save as a MovieList
ML = MovieList(MDs,'/work/bioinformatics/s184919/Data/Jungsik/To_Develop_DX_FPAME_GUI_forJenny/ML2mov');
ML.setFilename('movieList.mat')
ML.sanityCheck

%% no need to run above script every time, can load from saved mat files:
clear
load('/work/bioinformatics/s184919/Data/Jungsik/To_Develop_DX_FPAME_GUI_forJenny/ML2mov/movieList.mat')
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% LB test:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         mapDescriptivesDirName, mapXCorrDirName)
    ...
    % 'parPoolNum', 4 is default value. so deleted
