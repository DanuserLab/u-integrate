...
% Andrew Jamieson - Test Script.

%% creat MDs from raw images:
% 25 frames for each MD, 2018-07-02
path1 = '/Users/andrew/Data/raw/Jungsik/mapDDX/mDia1-actin-MD1';
...
path2 = '/Users/andrew/Data/raw/Jungsik/mapDDX/mDia1-actin-MD2';
...
%% save as a MovieList
ML = MovieList(MDs,'C:\Users\Qiongjing Zou\Documents\MATLAB\example2movies\MovieList');
ML.setFilename('movieList.mat')
ML.sanityCheck

%% no need to run above script every time, can load from saved mat files:
load('C:\Users\Qiongjing Zou\Documents\MATLAB\example2movies\MovieList\movieList.mat')
