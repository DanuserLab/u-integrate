...
for i=1:numel(ML.movieDataFile_)
    ...
    ML_phaseDescriptives_LB(ML, i, maxLayer, 'Actin', 1, 'phaseDescriptives0p5mRL5_LB')
end
toc
...
MLsummary_FluctuationProfiling(ML, 'Actin', maxLayer, 'phaseDescriptives0p5mRL5_LB', ...
...
tic
for i=1:numel(ML.movieDataFile_)
    ML_meanCV_alongDepth_LB(ML, i, 5, 'Actin', 1, 'mapDescriptives_alongDepth_LB')
end
toc

%  MLsummary_alongDepth

MLsummary_alongDepth(ML,1,5,'Actin','mapDescriptives_alongDepth_LB', ...
...
mapXcorrCurvePermutation_Vel(MD, iChan, chanName, layerMax, figuresDir, ...
    'impute', 0, 'movingAvgSmoothing',0, 'omittedWindows', omitWin, 'subFrames', subFr, 'WithN', 0, 'numPerm', 100, 'lagMax', 40)
...
mapXcorrCurvePermutation(MD, iChan1, iChan2, chan1Name, chan2Name,layerMax,figuresDir, ...
   'impute', 0, 'parpoolNum', 2, 'WithN', 0, 'numPerm', 100, 'omittedWindows', omitWin, ...
