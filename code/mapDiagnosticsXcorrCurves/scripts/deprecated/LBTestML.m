function LBTestML(movieListOrProcess, varargin)
...
% structure
%
% Creat new file QuiescentWindowDetectionML.m to replace LBTestML.m.
% No longer use LBTestML.m after 10/24/2018
%
...
% arguments.
% If movieListOrProcess is a MovieList and does contain an LBTestProcess,
% then return the first instance of an LBTestProcess.
% If movieListOrProcess is an LBTestProcess, then return the Process and it's
% MovieList owner.
% Otherwise throw an error.
[movieList, process] = getOwnerAndProcess(movieListOrProcess,'LBTestProcessML',true);
