function varargout = GCA_2ComponentsProcessMLGUI(varargin)
%GCA_2ComponentsProcessMLGUI MATLAB code file for GCA_2ComponentsProcessMLGUI.fig
%      GCA_2COMPONENTSPROCESSMLGUI, by itself, creates a new GCA_2COMPONENTSPROCESSMLGUI or raises the existing
%      singleton*.
%
%      H = GCA_2COMPONENTSPROCESSMLGUI returns the handle to a new GCA_2COMPONENTSPROCESSMLGUI or the handle to
%      the existing singleton*.
%
%      GCA_3COMPONENTSPROCESSMLGUI('Property','Value',...) creates a new GCA_3COMPONENTSPROCESSMLGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to GCA_2ComponentsProcessMLGUI_OpeningFcn.  This calling syntax produces a
...
% Edit the above text to modify the response to help GCA_2ComponentsProcessMLGUI
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GCA_2ComponentsProcessMLGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GCA_2ComponentsProcessMLGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before GCA_2ComponentsProcessMLGUI is made visible.
function GCA_2ComponentsProcessMLGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes GCA_2ComponentsProcessMLGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GCA_2ComponentsProcessMLGUI_OutputFcn(hObject, eventdata, handles)
