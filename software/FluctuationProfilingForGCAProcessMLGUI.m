function varargout = FluctuationProfilingForGCAProcessMLGUI(varargin)
%FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI MATLAB code file for FluctuationProfilingForGCAProcessMLGUI.fig
%      FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI, by itself, creates a new FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI or raises the existing
%      singleton*.
%
%      H = FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI returns the handle to a new FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI or the handle to
%      the existing singleton*.
%
%      FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI('Property','Value',...) creates a new FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to FluctuationProfilingForGCAProcessMLGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI('CALLBACK') and FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in FLUCTUATIONPROFILINGFORGCAPROCESSMLGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help FluctuationProfilingForGCAProcessMLGUI

% Last Modified by GUIDE v2.5 19-Jul-2021 15:23:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FluctuationProfilingForGCAProcessMLGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @FluctuationProfilingForGCAProcessMLGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before FluctuationProfilingForGCAProcessMLGUI is made visible.
function FluctuationProfilingForGCAProcessMLGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
set(handles.edit_smParamPhaseSegmentation, 'String', num2str(funParams.smParamPhaseSegmentation)) 
...
% UIWAIT makes FluctuationProfilingForGCAProcessMLGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FluctuationProfilingForGCAProcessMLGUI_OutputFcn(hObject, eventdata, handles)
...
funParams.smParamPhaseSegmentation = str2double(get(handles.edit_smParamPhaseSegmentation, 'String')); 
...
function edit_smParamPhaseSegmentation_Callback(hObject, eventdata, handles)
% hObject    handle to edit_smParamPhaseSegmentation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_smParamPhaseSegmentation as text
%        str2double(get(hObject,'String')) returns contents of edit_smParamPhaseSegmentation as a double


% --- Executes during object creation, after setting all properties.
function edit_smParamPhaseSegmentation_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_smParamPhaseSegmentation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function edit_minimumRunLength_Callback(hObject, eventdata, handles)
