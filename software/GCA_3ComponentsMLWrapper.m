function GCA_3ComponentsMLWrapper(movieListOrProcess, varargin)
...
[movieList, process] = getOwnerAndProcess(movieListOrProcess,'GCA_3ComponentsProcessML',true);
...
outName = ['GCA_3Components_', p.chanNameWithPreprocess{1}, '_', p.chanNameWithPreprocess{2}];
...
for j = 1:numMDs
    ...
    for r = 1:size(relationMat, 1)
        ...
        MD_iGC_SPAR3ch(movieData, iChan1, iChan2, iChan3, chan1Name, chan2Name, chan3Name, ...
...
for r = 1:size(relationMat, 1)
    ...
    MLsummary_iGC_SPAR3ch(movieList, chan1Name, chan2Name, chan3Name, ...
