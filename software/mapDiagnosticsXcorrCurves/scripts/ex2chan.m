...
mapDescriptives_OneChan(MD, iChan0, 1, chan0Name, chan0Title, figuresDir, ...
     'adf', 1, 'omittedWindows', [], 'subFrames', subFr, 'numPerm', 2, 'topograph', 'on', 'parpoolNum', 2) %QZ I changed 'parpoolNum' from 6 to 2.
...
mapDescriptives_OneChan(MD, iChan, maxLayer, chanName, chanTitle, figuresDir, ...
     'adf', 1, 'omittedWindows', [], 'subFrames', subFr, 'numPerm', 2, 'topograph', 'on', 'parpoolNum', 2, 'WithN', 0) %QZ I changed 'parpoolNum' from 6 to 2.
...
mapXcorrCurvePermutation_Vel(MD, iChan, chanName, layerMax, figuresDir, ...
    'impute', 0, 'subFrames', subFr, 'parpoolNum', 2, 'WithN', 0, 'numPerm', 2) %QZ I changed 'parpoolNum' from 6 to 2.
