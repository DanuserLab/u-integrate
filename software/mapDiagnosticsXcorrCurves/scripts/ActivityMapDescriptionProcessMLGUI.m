function varargout = ActivityMapDescriptionProcessMLGUI(varargin)
%ActivityMapDescriptionProcessMLGUI MATLAB code file for ActivityMapDescriptionProcessMLGUI.fig
%      ActivityMapDescriptionProcessMLGUI, by itself, creates a new ActivityMapDescriptionProcessMLGUI or raises the existing
%      singleton*.
%
%      H = ActivityMapDescriptionProcessMLGUI returns the handle to a new ActivityMapDescriptionProcessMLGUI or the handle to
%      the existing singleton*.
%
%      ActivityMapDescriptionProcessMLGUI('Property','Value',...) creates a new ActivityMapDescriptionProcessMLGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ActivityMapDescriptionProcessMLGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      ActivityMapDescriptionProcessMLGUI('CALLBACK') and ActivityMapDescriptionProcessMLGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in ActivityMapDescriptionProcessMLGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help ActivityMapDescriptionProcessMLGUI

% Last Modified by GUIDE v2.5 21-Nov-2018 15:09:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ActivityMapDescriptionProcessMLGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @ActivityMapDescriptionProcessMLGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ActivityMapDescriptionProcessMLGUI is made visible.
function ActivityMapDescriptionProcessMLGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for ActivityMapDescriptionProcessMLGUI
...
function varargout = ActivityMapDescriptionProcessMLGUI_OutputFcn(hObject, eventdata, handles)
...
if get(handles.checkbox_adf, 'Value')
    funParams.adf = true;
else
    funParams.adf = false;
end
