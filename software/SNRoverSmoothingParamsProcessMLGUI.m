function varargout = SNRoverSmoothingParamsProcessMLGUI(varargin)
%SNROVERSMOOTHINGPARAMSPROCESSMLGUI MATLAB code file for SNRoverSmoothingParamsProcessMLGUI.fig
%      SNROVERSMOOTHINGPARAMSPROCESSMLGUI, by itself, creates a new SNROVERSMOOTHINGPARAMSPROCESSMLGUI or raises the existing
%      singleton*.
%
%      H = SNROVERSMOOTHINGPARAMSPROCESSMLGUI returns the handle to a new SNROVERSMOOTHINGPARAMSPROCESSMLGUI or the handle to
%      the existing singleton*.
%
%      SNROVERSMOOTHINGPARAMSPROCESSMLGUI('Property','Value',...) creates a new SNROVERSMOOTHINGPARAMSPROCESSMLGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to SNRoverSmoothingParamsProcessMLGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SNROVERSMOOTHINGPARAMSPROCESSMLGUI('CALLBACK') and SNROVERSMOOTHINGPARAMSPROCESSMLGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SNROVERSMOOTHINGPARAMSPROCESSMLGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help SNRoverSmoothingParamsProcessMLGUI

% Last Modified by GUIDE v2.5 17-Jul-2021 19:45:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SNRoverSmoothingParamsProcessMLGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @SNRoverSmoothingParamsProcessMLGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before SNRoverSmoothingParamsProcessMLGUI is made visible.
function SNRoverSmoothingParamsProcessMLGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
set(handles.edit_ARorder, 'String',num2str(funParams.ARorder))
...
% UIWAIT makes SNRoverSmoothingParamsProcessMLGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SNRoverSmoothingParamsProcessMLGUI_OutputFcn(hObject, eventdata, handles)
...
% edit text
funParams.ARorder = str2double(get(handles.edit_ARorder, 'String'));
...
function edit_ARorder_Callback(hObject, eventdata, handles)
% hObject    handle to edit_ARorder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_ARorder as text
%        str2double(get(hObject,'String')) returns contents of edit_ARorder as a double


% --- Executes during object creation, after setting all properties.
function edit_ARorder_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_ARorder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
