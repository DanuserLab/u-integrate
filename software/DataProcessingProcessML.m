classdef DataProcessingProcessML < Process
...
%
% ML, but
% comment out Line 33 to 57, and line 15.
% DataProcessingProcessML is created for owner being ML.
%
% Add folderDisplay method to display folders when click folder(open) icon
% on packageGUI, when outFilePaths is more than one.
%
...
% 
    ...
    methods (Access = public)
        ...
        function obj = DataProcessingProcessML(owner,name,funName,funParams)
...
%             end
        ...
        function ofigure = folderDisplay(obj)
            ofigure = folderViewer(obj.getOwner(), 'procId', ...
