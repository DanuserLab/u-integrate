function MLsummary_iGC_SPAR3ch(ML, chan1Name, chan2Name, chan3Name, ...
    maxLayer, analName, varargin)
% MLsummary_iGC_SPAR3ch Collect/Summarize GC subcellular P-values computed by
% ML_iGC_SPAR3ch() into per-cell median P-values. Then it constructs GC
...
disp('===============================================================')
disp(['== GC 3ch from ', chan1Name, ' to ', chan2Name, ' given ', chan3Name])
disp('===============================================================')
...
fsaveName0 = ['fr_', chan1Name, '_to_', chan2Name, '_given_', chan3Name];
...
ip = inputParser;
ip.addParameter('outDirName', ['iGC_SPAR3ch_', fsaveName0]);
...
tab = array2table(medFpvalMat, 'VariableNames', condNames);   %, 'RowNames', cellLabels);
...
title0 = ['GC from ', chan1Name, ' to ', chan2Name, ' given ', chan3Name];
...
title0 = ['GC partial R-squares from ', chan1Name, ' to ', chan2Name, ' given ', chan3Name];
%
...
%%
disp('==== MLsummary_iGC_SPAR3ch is finished!! ====')
