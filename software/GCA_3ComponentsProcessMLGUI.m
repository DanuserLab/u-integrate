function varargout = GCA_3ComponentsProcessMLGUI(varargin)
%GCA_3COMPONENTSPROCESSMLGUI MATLAB code file for GCA_3ComponentsProcessMLGUI.fig
%      GCA_3COMPONENTSPROCESSMLGUI, by itself, creates a new GCA_3COMPONENTSPROCESSMLGUI or raises the existing
%      singleton*.
%
%      H = GCA_3COMPONENTSPROCESSMLGUI returns the handle to a new GCA_3COMPONENTSPROCESSMLGUI or the handle to
%      the existing singleton*.
%
%      GCA_3COMPONENTSPROCESSMLGUI('Property','Value',...) creates a new GCA_3COMPONENTSPROCESSMLGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to GCA_3ComponentsProcessMLGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GCA_3COMPONENTSPROCESSMLGUI('CALLBACK') and GCA_3COMPONENTSPROCESSMLGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GCA_3COMPONENTSPROCESSMLGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help GCA_3ComponentsProcessMLGUI

% Last Modified by GUIDE v2.5 19-Jul-2021 16:21:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GCA_3ComponentsProcessMLGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GCA_3ComponentsProcessMLGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before GCA_3ComponentsProcessMLGUI is made visible.
function GCA_3ComponentsProcessMLGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes GCA_3ComponentsProcessMLGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GCA_3ComponentsProcessMLGUI_OutputFcn(hObject, eventdata, handles)
